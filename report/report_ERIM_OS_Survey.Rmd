...
Notably, however, the majority of respondents (`r paste0(pull(filter(ESE_materials_concerns, item == "I do not share any of these concerns"), "perc"), "%")`) did not share any of the listed concerns (see Figure \@ref(fig:ESE-figure6)).
...
Notably, however, the majority of respondents (`r paste0(pull(filter(RSM_materials_concerns, item == "I do not share any of these concerns"), "perc"), "%")`) did not share any of the listed concerns (see Figure \@ref(fig:RSM-figure6)).
...
* *`r ESE_archiving_concerns$item[1]`* (`r ESE_archiving_concerns[1, "lab_perc"]`)
...
More details can be found in Figure \@ref(fig:ESE-figure11).
...
* *`r RSM_archiving_concerns$item[3]`* (`r RSM_archiving_concerns[3, "lab_perc"]`)
* *`r RSM_archiving_concerns$item[4]`* (`r RSM_archiving_concerns[4, "lab_perc"]`)

More details can be found in Figure \@ref(fig:RSM-figure11).
