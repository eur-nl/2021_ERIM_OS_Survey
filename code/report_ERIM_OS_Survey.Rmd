...
The Erasmus Research Institute of Management (ERIM) is committed to making Open Science practices the norm within its researchers.
...
Open Science increases transparency throughout the research cycle, resulting in increased research efficiency and enhanced research quality, visibility, and engagement.
...
**Preregistration**; researchers think is important but only a few are regularly preregistering their research, so we will have a module about it in the Open Science MOOC on which we will tackle researchers' concerns.
...
**Pre-publication**; researchers think is very important to quickly disseminate their results, but only around 20% of them are using pre-prints, and a large percentage of respondents were not aware of them. To tackle this, we will add a module on pre-publication archiving in the Open Science MOOC on which we will explain its benefits and tackle respondents' concerns. 
