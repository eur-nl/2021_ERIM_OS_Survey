...
**Preregistration**: researchers think is important but only a few are regularly preregistering their research, so we will have a module about it in the Open Science MOOC where we will tackle researchers' concerns.
