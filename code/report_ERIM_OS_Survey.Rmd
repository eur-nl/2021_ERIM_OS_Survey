---
title: "Report of the 2021 ERIM Open Science Srping Survey"
...
The Erasmus Research Institute of Management (ERIM) is committed ERIM is committed to make Open Science practices the norm withing its researchers.
...
Because of these reasons, ERIM wanted to have a baseline on what and how much open science practices its researchers are already engaging with and which ones do they want to learn more about. These questions created the need to conduct a survey.

The RSM & ESE Open Science Spring Survey was open to all researchers from the 6th of April to the 6th of May 2021. Questions were adapted from the [Swinburne Open Science Survey](https://osf.io/vpwf7/).
...
```{r figure3, fig.cap = "Preregistration: concenrns", out.width = '100%'}
...
```{r figure14, fig.cap = "Open science tools: awarness", out.width = '100%'}
...
ERIM is committed to make Open Science practices the norm withing its researchers. 
...
In 2021, ERIM kicked off in March with the ORCiD Madness Month, it then conducted the Open Science Spring Survey during the month of April. Later in the autum, ERIM will continue in October with the October DataFest, and ERIM also got awarded a Stepping Up Professional Services grant to create an Open Science Massive Online Open Course (MOOC).

The ORCiD Madness Month brough to light the importance of having a unique identifier to your research profile, and as a result, we saw an increase of 72 new ORCiD accounts created between RSM and ESE researchers. 
...
**Preregistration**; researchers think is important but only a few are regularly preregistrating their research, so we will have a module about it in the Open Science MOOC on which we will tackle the concerns researchers rose.

**Open materials and/or code and data**; researchers find this very important, this is why we decided to use the whole month of October dedicated to open data. The ERIM October DataFest is intended to bring awareness on open data and promote the use of the Erasmus Data Repository (EDR). One of the events of the DataFest will tackle the top 5 concerns researchers have on open materials and/or code and data.

**Pre-publication**; researchers think is very important to pre-publication their results but only around 20% of them are using pre-prints, and a large percentage of respondents were not aware of it. To tackle this, we will add a module on pre-publication archiving in the Open Science MOOC on which we will explain its benefits and we will tackle the concerns rose by the respondents. 

**Open Access**; less than 20% of the respondents have all their publication open access, fortunately for ERIM and the EUR, this percentage will change in the coming months/years, since EUR's researchers have agreed to follow the taverne amendment, on which any publication that is not already open access will be made open (by law) after 6 months of its publication. To go into more details on this we will include a module on open access in our Open Science MOOC.

**Open Science practices**; the most relevant barrier to open science (excluding open access, because of the taverne amendment) is the lack of recognition in the field and lack of credit by the institution. There is a lot of effort on this front, ERIM is redesigning its member chart, to include open science to it, funding agencies now require you to follow and stick to open science practices and EUR has a whole has a task force that is also redesigning rewards and recognition for its researchers. 

All in all, ERIM has started the year 2021 with a new strategy in place: to make open science the norm within its researchers. 
