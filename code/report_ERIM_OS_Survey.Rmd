...
ERIM is committed to make Open Science (OS) practices the norm withing its researchers. 
...
The ERIM October DataFest is intended to bring awareness on open data and promote the use of the Erasmus Data Repository (EDR). The DataFest will also be used to tackle the top 5 concerns researchers have on open data, these concerns come from their answers to this Open Science Spring Survey.
